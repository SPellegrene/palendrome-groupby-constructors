...
//
// // 5. Create a constructor called `Key`.
//Create another constructor called `Safe`.
//Make the Safe constructor take 2 arguments.
//The first argument can be any piece if data to keep safe.
...
//Add a function to the Safe prototype called `unlock` that accepts a key. If the key matches the key that was used to create the Safe;
